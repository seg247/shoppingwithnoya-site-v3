// Clean SVG icons — no external library needed
// Consistent 20x20 viewBox, currentColor for theming
...
export function BookmarkIcon({ filled = false, size = 20 }: { filled?: boolean; size?: number }) {
  return (
